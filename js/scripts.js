$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Eve and Nick's Wedding",

            // Event start date
            start: new Date('Mar 2, 2025 15:09'),
            ...
            end: new Date('Mar 2, 2025 22:00'),

            // Event Address
            address: 'NT Grand Ballroom, National Telecom PLC - HQ, Bangkok',

            // Event Description
            description: "We can't wait to see you on our big day. For any queries or issues, please contact me at +66 847224978."
        }
    });
...
// Google map
function initMap() {
    var location = {lat: 13.8821799, lng: 100.568051};
